...
#### `How to` guide
---
First of all, please make sure that you have at least 1 GPU on hand (16GB memory is required to run the device model). You can prepare the Python enviroment for the demo with 
```python
#either
